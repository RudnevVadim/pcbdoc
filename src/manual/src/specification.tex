...
аргумент имеет значение \sfemph{0}, счетчик позиционного обозначения не
инкрементируется, а в колонку \colorbox{resultcolor}{\sfemph{~~Поз~~}} ничего не записывается. Если значением
...
случаях в колонку {\sfemph{~~Поз~~}} записывается значение счетчика. Аргументы
\sfemph{<format>}, \sfemph{<zone>}, \sfemph{<designating>}, \sfemph{<naming>},
\sfemph{<quantity>} и \sfemph{<note>} печатаются в колонках
