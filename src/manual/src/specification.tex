...
\resultbox{\sfemph{Формат}}. В случае, если аргумент \sfemph{<format>} не
...
разделов спецификации(команда \bfemph{\textbackslash{}Part}), а также для заполнения
раздела \sfemph{Документация}. Например:
...
аргумент \sfemph{<reference>} управляет встроенным счётчиком позиционного
